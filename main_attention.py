...
model = model_attention.RNNModel(args.model, ntokens, args.emsize, args.nhid, args.nlayers, args.dropout, args.tied).to(device)
...
def evaluate(data_source):  #
    ...
    with torch.no_grad():
        for i in range(0, data_source.size(0) - 2, args.bptt):
            ...
            output, attn_weights = model(data_left, data_right, hidden_left, hidden_right)
